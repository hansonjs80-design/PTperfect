          ...
          <div className="flex-1 min-w-0 h-full flex items-center justify-start pl-2 pr-[4px] py-0 gap-1.5">
            {presetLabel && (
              <span 
                ...
                className={`shrink-0 px-1.5 py-[0.12rem] rounded-[0.4rem] text-[14.3px] font-black ${presetColor} ${presetBadgeTextClass} border ${isBadgeSelected ? 'border-sky-500 outline outline-2 outline-sky-500 shadow-[0_0_8px_rgba(14,165,233,0.5)]' : 'border-black/10 dark:border-white/10'} cursor-pointer transition-all duration-150 group-hover:scale-[1.03] transform-gpu`}
              >
                {presetLabel}
              </span>
            )}
