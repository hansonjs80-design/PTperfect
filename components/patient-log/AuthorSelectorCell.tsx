...
export const AuthorSelectorCell: React.FC<AuthorSelectorCellProps> = ({
  ...
  return (
    <>
      <div
        ref={cellRef}
        className={`absolute inset-0 px-2 flex items-center justify-center text-center cursor-pointer hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors group outline-none focus:shadow-[inset_0_0_0_1px_rgb(56_189_248)] ${isDraft ? 'opacity-50 hover:opacity-100' : ''}`}
