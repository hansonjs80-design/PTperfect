  ...
  if (mode === 'edit') {
    return (
      <input
        {...commonInputProps}
        autoFocus
        className={`w-full h-full bg-white dark:bg-slate-700 px-2 py-1 outline-none border-2 border-brand-500 rounded-sm text-sm text-center !text-gray-900 dark:!text-gray-100 ${className} focus:outline focus:outline-2 focus:outline-sky-400 focus:outline-offset-[-1px] focus:z-10`}
      />
    );
  }
      ...
      <div className="w-full h-full relative">
        <input
          ...
          className={`
            ...
            ${directEdit ? 'cursor-default select-none caret-transparent' : 'cursor-pointer'} hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors text-sm truncate
            focus:outline focus:outline-2 focus:outline-sky-400 focus:outline-offset-[-1px] focus:z-10 focus:bg-white dark:focus:bg-slate-800
