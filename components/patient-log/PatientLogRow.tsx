...
export const PatientLogRow: React.FC<PatientLogRowProps> = memo(({
  ...
  return (
    <>
      ...
      <td className={`${cellBorderClass} p-0 relative align-middle text-center min-w-[96px]`}>
        <AuthorSelectorCell
          gridId={`${rowIndex}-9`}
          rowIndex={rowIndex}
          colIndex={9}
      ...
      <td className="p-0 relative text-center min-w-[52px] border-l-2 border-slate-300 dark:border-slate-600">
