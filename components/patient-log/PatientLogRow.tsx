...
export const PatientLogRow: React.FC<PatientLogRowProps> = memo(({
  ...
  return (
    <>
      ...
      <td data-grid-cell-id={`${rowIndex}-10`} className="p-0 align-middle text-center min-w-[38px] w-[38px] max-w-[38px] xl:w-[46px] xl:min-w-[46px] xl:max-w-[46px] border-r border-slate-300 dark:border-slate-600">
