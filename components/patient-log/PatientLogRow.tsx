...
import { findExactPresetByTreatmentString, formatTime, generateTreatmentString, normalizeTreatmentString } from '../../utils/bedUtils';
...
export const PatientLogRow: React.FC<PatientLogRowProps> = memo(({
  ...
  return (
    <>
      ...
      <td className="p-0 text-center w-[15px] min-w-[15px] max-w-[15px]">
