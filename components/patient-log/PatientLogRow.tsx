...
export const PatientLogRow: React.FC<PatientLogRowProps> = memo(({
  ...
  return (
    <>
      ...
      <td className={`${cellBorderClass} p-0 align-middle text-center w-[96px] min-w-[96px] max-w-[96px]`}>
        <AuthorSelectorCell
          gridId={`${rowIndex}-9`}
          rowIndex={rowIndex}
          colIndex={9}
      ...
      <td className="p-0 text-center min-w-[52px] border-l border-slate-200 dark:border-slate-700">
