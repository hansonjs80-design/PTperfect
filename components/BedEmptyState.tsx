...
export const BedEmptyState: React.FC<BedEmptyStateProps> = ({ onOpenSelector, onStartTimerOnly }) => {
  ...
  return (
    ...
    >
      ...
      <label
        className="mt-3 flex items-center gap-1.5 text-[11px] font-bold text-slate-500 dark:text-slate-300 bg-white/80 dark:bg-slate-800/80 px-2 py-1 rounded-lg border border-slate-200 dark:border-slate-700"
