      ...
      >
        ...
        <div className="flex-1 flex justify-end items-center gap-0 sm:gap-1 lg:gap-2 pl-0 sm:pl-2">
          {bed.status !== BedStatus.IDLE && (
            <div className="flex flex-col items-end max-w-[78px] md:max-w-[88px] lg:max-w-[120px] mr-1 lg:mr-2 leading-tight">
              {isEditingName ? (
                <input
                  autoFocus
                  value={nameDraft}
                  ...
                  className="w-full text-right bg-white/80 dark:bg-slate-700/80 border border-indigo-400 rounded px-1 text-[12px] md:text-base lg:text-lg font-black text-slate-700 dark:text-slate-200"
                  placeholder="이름"
                />
              ) : (
                <button
                  ...
                  className="w-full text-right text-[12px] md:text-base lg:text-lg font-black text-slate-700 dark:text-slate-200 truncate"
                  title="이름 입력/수정"
                >
                  {patientName || '+ 이름'}
                </button>
              ...
              {isEditingBodyPart ? (
                <input
                  ...
                  onClick={(e) => e.stopPropagation()}
                  className="mt-0.5 w-full text-right bg-white/80 dark:bg-slate-700/80 border border-indigo-300 rounded px-1 text-[9px] md:text-xs lg:text-sm font-bold text-slate-500 dark:text-slate-400"
                  placeholder="부위"
                />
              ) : (
                <button
                  ...
                  className="mt-0.5 w-full text-right text-[9px] md:text-xs lg:text-sm font-bold text-slate-500 dark:text-slate-400 truncate"
                  title="부위 입력/수정"
                >
                  {patientBodyPart || '+ 부위'}
                </button>
