...
export const BedCard: React.FC<BedCardProps> = memo(({
  ...
  const desktopActiveHeightClass = bed.status !== BedStatus.IDLE ? 'lg:h-[70%] lg:min-h-0 lg:self-start' : '';

  return (
    <div className={`${containerClass} ${desktopActiveHeightClass} transform transition-transform duration-200 active:scale-[0.99]`}>
      <BedHeader
        bed={bed}
